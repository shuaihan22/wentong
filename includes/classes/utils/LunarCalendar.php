 ...
 * 农历类
 * 
 * @author Leo Ning 2011-09-01 <leo.ning@like18.com>
 *
 */
class LunarCalendar {
	...
	private static $nStr1 = array ("日","一","二","三","四","五","六","七","八","九","十" );
	private static $nStr2 = array ("初","十","廿","卅","　" );
	private static $monthNong = array ("正","正","二","三","四","五","六","七","八","九","十","十一","腊" );
	private static $yearName = array ("零","壹","贰","叁","肆","伍","陆","柒","捌","玖" );
	...
	private function leapDays($y) {
		if ($this->leapMonth ( $y ) != 0)
			return ((self::$lunarInfo [$y - 1900] & 0x10000) == 0 ? 29 : 30);
		else
			return (0);
	}
