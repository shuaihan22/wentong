...
class ChannelController extends Controller {
	...
	public function add($type = 0, $upid = 0) {
		...
		dbselect ( '*' )->from ( '{cms_model}' )->treeWhere ( array ('deleted' => 0,'is_topic_model' => $type,'creatable' => 1 ) )->treeKey ( 'refid' )->treeOption ( $data ['models'] );
	...
	public function edit($id) {
		...
		if ($ch) {
			...
			dbselect ( '*' )->from ( '{cms_model}' )->treeWhere ( array ('deleted' => 0,'hidden' => 0,'is_topic_model' => $type ) )->treeKey ( 'refid' )->treeOption ( $ch ['models'] );
