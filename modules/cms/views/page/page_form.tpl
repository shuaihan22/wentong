							...
							<fieldset>												
								...
								<div class="row">
									...
									<section class="col col-2">
										...
										<label class="input">
										<input type="text" value="{$tag}" id="tag" name="tag"/>
										</label>
									</section>
									<section class="col col-3">
								...
								<div class="row">
									<section class="col col-4">
										...
										id="keywords">{$keywords|escape}</textarea>
										</label>										
									</section>
									<section class="col col-8">
								...
								<section id="pageEditorWrapper" {if $flag_j}style="display:none"{/if}>
									<textarea id="page_content" name="content" type="text/plain" style="height:300px;width:100%" rows="20" cols="100">{$content|escape}</textarea> 
								</section>
								<div class="row">
									<section class="col col-2">
										...
										<div class="inline-group">										
											<label class="checkbox">
											<input type="checkbox" {if $img_pagination}checked="checked"{/if}  name="img_pagination"/>
											<i></i></label>										
										</div>
									</section>
									<section class="col col-10">
										...
										id="img_next_page" value="{$img_next_page}"/></label>
									</section>
								</div>
								<section>
									<label class="label">图片跟随内容</label>
									<label class="textarea textarea-expandable">
									<textarea class="custom-scroll" name="img_follow" rows="3" id="img_follow">{$img_follow|escape}</textarea>
									</label>										
								</section>
								<div class="row">									
									<section class="col col-2">
