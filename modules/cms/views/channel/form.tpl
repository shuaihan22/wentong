                ...
                <div>
                     <div class="widget-body widget-hide-overflow no-padding">
                          ...
                          <form name="ChannelForm"                          		
                          		data-widget="nuiValidate" action="{'cms/channel/save'|app}" 
							...
							<fieldset>								
								<div class="row">
									...
									<section class="col col-4">
										...
										{channel_tree name=upid id=upid value=$upid cid=$id type=$type placeholder="顶级栏目"}
									</section>
									{else}
								...
								<section>									
									<div class="inline-group">										
										...
										<label class="checkbox">
											<input type="checkbox" name="catalog" {if $catalog}checked="checked"{/if}/>
											<i></i>信息分类栏目.
										</label>
									</div>
								</section>
								...
								<section>
									...
									<label class="textarea">										
										<textarea rows="4" 
											name="description" id="description">{$description|escape}</textarea>
									</label>									
								</section>
							</fieldset>
