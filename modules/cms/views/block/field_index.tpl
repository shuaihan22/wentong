<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 hidden-xs hidden-sm">
		<h1 class="txt-color-blueDark">
			...
			<span>&nbsp;&gt;&nbsp;<a href="#{'cms/blockitem'|app:0}{$blockId}">{$blockName}</a></span>
			<span>&nbsp;&gt;&nbsp;字段管理</span>			
		</h1>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
		<div class="pull-right margin-top-5 margin-bottom-5">
			...
			<a class="btn btn-labeled btn-success"
					href="#{'cms/blockfield/add'|app:0}{$block}">
			...
			<button type="button" 
					...
					data-url="{'cms/blockfield/del'|app}"
					target="ajax"					
				...
				<table 
					...
					<tbody>
						...
						<tr name="field" rel="{$item.id}">
							...
							<td>
								<a href="#{'cms/blockfield/edit'|app:0}{$item.id}">
									{$item.name}
								</a>							
							</td>
							<td>{$item.label}</td>
							...
							<td class="text-right">
								{if $canDelModel}
								<a href="{'cms/blockfield/del'|app}{$item.id}" 
