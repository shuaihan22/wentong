...
var calc_navbar_height = function() {
	...
	app.layoutSetting = function() {
		...
		$('#layoutp-setting').click(function() {
			$('#main .layoutp').toggleClass('activate');
		});
		/*
		 * FIXED HEADER
		 */
		$('input[type="checkbox"]#smart-fixed-nav').click(
				function() {
					if ($(this).is(':checked')) {
						...
						// unchecked
						$('input[type="checkbox"]#smart-fixed-ribbon').prop(
								'checked', false);
		...
		$('input[type="checkbox"]#smart-fixed-ribbon').click(
				function() {
					if ($(this).is(':checked')) {
						// checked
						$('input[type="checkbox"]#smart-fixed-nav').prop(
								'checked', true);

						$.root_.addClass("fixed-header");
						$.root_.addClass("fixed-ribbon");

						$('input[type="checkbox"]#smart-fixed-container').prop(
								'checked', false);
		...
		$("#smart-styles > a")
				.bind(
						...
						function() {
							var $this = $(this);
							var $logo = $("#logo img");
							$('html').removeClassPrefix('smart-style').addClass(
									$this.attr("id"));
							$.root_.removeClassPrefix('smart-style').addClass(
									$this.attr("id"));
							$logo.attr('src', $this.data("skinlogo"));
							$("#smart-styles > a #skin-checked").remove();
							$this
									.prepend("<i class='fa fa-check fa-fw' id='skin-checked'></i>");
						});
