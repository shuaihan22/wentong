	  ...
	  {cts var=name from=block refid='com_logo' sortby='sort' order='d' limit=1}
         ...
         <div class="nav_l">
            <ul>
               ...
               <li><a href="/Executive%20Education" class="on">Executive Education</a></li>
...
<!--内容-->
   <!--第一屏-->
        <div class="section">
		{cts var=name from=block refid='senior_pic' sortby='sort' order='d' limit='1,1'}
           <div class="project">
				  ...
				  {cts var=name from=pages model='news' channel=$channel sortby='publish_time' order='d' pp='off'}
                   <li>
                      ...
                      <div class="news_xj">
                         ...
                         <p><span>Target：</span>{$name.object}</p>
                         <p><span>Site：</span>{$name.object_time}</p>
