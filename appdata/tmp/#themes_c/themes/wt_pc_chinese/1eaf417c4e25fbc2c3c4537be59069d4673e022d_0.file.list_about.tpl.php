<?php /* Smarty version 3.1.27, created on 2017-01-22 11:20:30
         compiled from "F:\wamp\www\6\themes\wt_pc_chinese\list_about.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:27987588424fe2aeb79_64223459%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1eaf417c4e25fbc2c3c4537be59069d4673e022d' => 
    array (
      0 => 'F:\\wamp\\www\\6\\themes\\wt_pc_chinese\\list_about.tpl',
      1 => 1485054926,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '27987588424fe2aeb79_64223459',
  'variables' => 
  array (
    'title' => 0,
    'keywords' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_588424fe328977_11010142',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_588424fe328977_11010142')) {
function content_588424fe328977_11010142 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '27987588424fe2aeb79_64223459';
?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        <div class="section">
	       <div class="about_us">
              <div class="about_intro w1000">
				  ...
				  <?php  $_smarty_tpl->tpl_vars['name'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['name']->_loop = false;
 $_name_data = get_data_from_cts_provider('block', array('refid'=>'aboutus','sortby'=>'sort','order'=>'d','nocache'=>false),$_smarty_tpl->tpl_vars);
 $_smarty_tpl->tpl_vars['name_total'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['name_total']->value = $_name_data['size'];
 $_from = $_name_data;
if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
        ...
        <div class="section">
           <div class="wttd">
              <div class="wttd_intro w1000">
                <div class="about_title w1000">师资力量</div>
                <div class="line"></div>
	             <!---->  
...
<?php echo '<script'; ?>
 type="text/javascript">
	$(".content") .hover(function(){
			$(this) .children(".txt").stop() .animate({height:"320px"},200);
			$(this) .find(".txt h3").stop() .animate({paddingTop:"0px"},550);
			$(this) .find(".txt p").stop() .show();
	},function(){
			$(this) .children(".txt").stop() .animate({height:"120px"},200);
			$(this) .find(".txt h3").stop().animate({paddingTop:"0px"},550);
